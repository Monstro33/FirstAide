...
namespace FirstAide.Migrations
{
    ...
    [Migration("20190407180522_manyToManySeedData")]
            ...
            modelBuilder.Entity("FirstAide.Models.Instructions", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { InstructionsId = 4, AgeGroupId = 1, Details = "", EmergencyId = 2 },
                        new { InstructionsId = 5, AgeGroupId = 2, Details = "", EmergencyId = 2 },
                        new { InstructionsId = 6, AgeGroupId = 3, Details = "", EmergencyId = 2 },
                        new { InstructionsId = 7, AgeGroupId = 1, Details = "/markdown/Unconcious/UnconciousInfant/CprInfant/UnconciousInfant.md", EmergencyId = 3 },
                        new { InstructionsId = 8, AgeGroupId = 2, Details = "/markdown/Unconcious/UnconciousChild/UnconciousChild.md", EmergencyId = 3 },
                        new { InstructionsId = 9, AgeGroupId = 3, Details = "", EmergencyId = 3 }
                    );
                });
