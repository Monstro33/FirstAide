...
namespace FirstAide.Migrations
{
    ...
    [Migration("20190409140149_FixedMarkdownFilePaths")]
    partial class FixedMarkdownFilePaths
    {
            ...
            modelBuilder.Entity("FirstAide.Models.Instructions", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { InstructionsId = 4, AgeGroupId = 1, Details = "/markdown/AllergicReactionInfant/allergicReactionInfant.md", EmergencyId = 2 },
                        new { InstructionsId = 5, AgeGroupId = 2, Details = "/markdown/AllergicReactionChild/allergicReactionChild.md", EmergencyId = 2 },
                        new { InstructionsId = 6, AgeGroupId = 3, Details = "/markdown/AllergicReactionAdult/allergicReactionAdult.md", EmergencyId = 2 },
