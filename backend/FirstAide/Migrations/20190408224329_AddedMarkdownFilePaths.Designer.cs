...
namespace FirstAide.Migrations
{
    ...
    [Migration("20190408224329_AddedMarkdownFilePaths")]
    partial class AddedMarkdownFilePaths
    {
            ...
            modelBuilder.Entity("FirstAide.Models.Instructions", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { InstructionsId = 4, AgeGroupId = 1, Details = "/AllergicReactionInfant/allergicReactionInfant.md", EmergencyId = 2 },
                        new { InstructionsId = 5, AgeGroupId = 2, Details = "/AllergicReactionChild/allergicReactionChild.md", EmergencyId = 2 },
                        new { InstructionsId = 6, AgeGroupId = 3, Details = "/AllergicReactionAdult/allergicReactionAdult.md", EmergencyId = 2 },
