...
namespace FirstAide.Migrations
{
    ...
    [Migration("20190405152219_changedPath")]
    partial class changedPath
    {
            ...
            modelBuilder.Entity("FirstAide.Models.Instructions", b =>
                {
                    ...
                    b.HasData(
                        new { InstructionsId = 1, AgeGroupId = 2, Details = "/markdown/Choking/ChokingChild/chokingConsciousChild.md", EmergencyId = 1 }
                    );
                });
